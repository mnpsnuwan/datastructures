 ...
 * Class : {@link FenwickTreeRangeQueriesPointUpdate}
 * User : Nuwan Samarasinghe | mnpsnuwan@gmail.com
 * Date : 05Dec2023
 * Time : 10:30 AM
 */
public class FenwickTreeRangeQueriesPointUpdate
{
    ...
    public FenwickTreeRangeQueriesPointUpdate( int sz )
    {
    ...
    public FenwickTreeRangeQueriesPointUpdate( long[] values )
    {
