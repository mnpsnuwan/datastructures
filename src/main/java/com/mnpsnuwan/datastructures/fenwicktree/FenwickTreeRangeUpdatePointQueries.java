 ...
 * Class : {@link FenwickTreeRangeUpdatePointQueries}
 * User : Nuwan Samarasinghe | mnpsnuwan@gmail.com
 * Date : 04Dec2023
 * Time : 4:55 PM
 */
public class FenwickTreeRangeUpdatePointQueries
{
    ...
    private final long[] originalTree;

    // The current tree will contain the updated range values
    private final long[] currentTree;
    ...
    public FenwickTreeRangeUpdatePointQueries( long[] values )
    {
