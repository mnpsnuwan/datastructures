...
import com.mnpsnuwan.datastructures.utils.TreePrinter;
 ...
 * times to go O(n) However, the amortized costs of this worst case situation is logarithmic, O(log(n))
 * *
 * Created by IntelliJ IDEA.
 * Project : datastructures
 * Class : {@link SplayTree}
    ...
    public static void main( String[] args )
    {
        ...
        while( c != 7 )
        {
            ...
            switch( c )
            {
                ...
                case 4 -> System.out.println( "Min: " + splayTree.findMin() );
                case 5 -> System.out.println( "Max: " + splayTree.findMax() );
                case 6 -> System.out.println( splayTree );
                case 7 -> sc.close();
            }
        }
    }
