 ...
 * Class : {@link BinarySearchTreeTest}
...
public class BinarySearchTreeTest
{
    ...
    public boolean validateTreeTraversal( TreeTraversalOrder traversalOrder, List<Integer> input )
    {
        ...
        {
            case PRE_ORDER -> TestTreeNode.preOrder( expected, testTree );
            case IN_ORDER -> TestTreeNode.inOrder( expected, testTree );
            case POST_ORDER -> TestTreeNode.postOrder( expected, testTree );
            case LEVEL_ORDER -> TestTreeNode.levelOrder( expected, testTree );
        }

        // Get traversal output
        Iterator<Integer> iter = tree.traverse( traversalOrder );
