package com.mnpsnuwan.datastructures.balancedtrees;
...
public class RedBlackTreeTest
{
    ...
    public void testLeftUncleCase()
    {
        ...
        assertThat( tree.root.left.value ).isEqualTo( 1 );
        assertThat( tree.root.right.value ).isEqualTo( 3 );
        assertThat( tree.root.right.right.value ).isEqualTo( 4 );
        ...
        assertThat( tree.root.value ).isEqualTo( 2 );
        assertThat( tree.root.left.value ).isEqualTo( 1 );
        assertThat( tree.root.right.value ).isEqualTo( 4 );
        assertThat( tree.root.right.left.value ).isEqualTo( 3 );
        assertThat( tree.root.right.right.value ).isEqualTo( 5 );
    ...
    public void testRightUncleCase()
    {
        ...
        assertThat( tree.root.value ).isEqualTo( 3 );
        ...
        assertThat( tree.root.left.right.value ).isEqualTo( 2 );
    ...
    public void interestingCase1()
    {
        ...
        assertThat( tree.root.value ).isEqualTo( 44 );

        assertThat( tree.root.left.value ).isEqualTo( 41 );
        assertThat( tree.root.right.value ).isEqualTo( 83 );

        assertThat( tree.root.right.left.value ).isEqualTo( 66 );
        assertThat( tree.root.right.right.value ).isEqualTo( 94 );

        assertThat( tree.root.right.left.left.value ).isEqualTo( 59 );
        assertThat( tree.root.right.left.right.value ).isEqualTo( 72 );
        assertThat( tree.root.right.right.left.value ).isEqualTo( 90 );
        assertThat( tree.root.right.right.right.value ).isEqualTo( 95 );
