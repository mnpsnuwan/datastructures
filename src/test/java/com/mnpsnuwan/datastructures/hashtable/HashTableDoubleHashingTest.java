 ...
 * Class : {@link HashTableDoubleHashingTest}
...
public class HashTableDoubleHashingTest {
    ...
    public void testIterator() {
        ...
        for (int loop = 0; loop < LOOPS; loop++) {
            ...
            Set<DoubleHashingTestObject> set = new HashSet<>( rand_nums );
    ...
    public void testRandomMapOperations() {
        ...
        for (int loop = 0; loop < LOOPS; loop++) {
            ...
            for (int i = 0; i < MAX_SIZE; i++) {
                ...
                if (r < probability1) assertThat(jMap.put(key, i )).isEqualTo(map.put(key, i ));
