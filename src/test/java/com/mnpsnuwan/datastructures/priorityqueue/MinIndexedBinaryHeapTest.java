 ...
 * Class : {@link MinIndexedBinaryHeapTest}
...
public class MinIndexedBinaryHeapTest
{
    ...
    {
        MinIndexedBinaryHeap<String> pq = new MinIndexedBinaryHeap<>( 10 );
        pq.insert( 5, "dictionaries" );
    ...
    {
        MinIndexedBinaryHeap<Integer> pq = new MinIndexedBinaryHeap<>( 10 );
        pq.insert( 3, 5 );
        pq.decrease( 3, 4 );
    ...
    public void testPeekAndPollMinIndex()
    {
        ...
        int n = pairs.length;
        MinIndexedBinaryHeap<Integer> pq = new MinIndexedBinaryHeap<>( n );
        for( Integer[] integers : pairs ) pq.insert( integers[0], integers[1] );

        int minIndex;
        for( Integer[] pair : pairs )
        {
            minIndex = pq.peekMinKeyIndex();
            assertThat( minIndex ).isEqualTo( pair[0] );
    ...
    public void testPeekAndPollMinValue()
    {
        ...
        int n = pairs.length;
        MinIndexedBinaryHeap<Integer> pq = new MinIndexedBinaryHeap<>( n );
        for( Integer[] pair : pairs ) pq.insert( pair[0], pair[1] );

        Integer minValue;
        for( Integer[] pair : pairs )
        {
            assertThat( pq.valueOf( pair[0] ) ).isEqualTo( pair[1] );
            minValue = pq.peekMinValue();
            assertThat( minValue ).isEqualTo( pair[1] );
    ...
    public void testInsertionAndValueOf()
    {
        ...
        MinIndexedBinaryHeap<String> pq = new MinIndexedBinaryHeap<>( names.length );
    ...
    public void testRandomInsertionsAndPolls()
    {
        for( int n = 1; n < 1500; n++ )
        {
            ...
            MinIndexedBinaryHeap<Integer> pq1 = new MinIndexedBinaryHeap<>( n );
