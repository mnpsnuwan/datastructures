...
public class BinaryHeapTest
{
    ...
    public void testContainment()
    {
        ...
        String[] strArray = { "aa", "bb", "cc", "dd", "ee" };
        BinaryHeap<String> q = new BinaryHeap<>( strArray );
        q.remove( "aa" );
    ...
    {
        List<Integer> lst = new ArrayList<>( BinaryHeapTest.MAX_SZ );
        for( int i = 0; i < BinaryHeapTest.MAX_SZ; i++ ) lst.add( i );
