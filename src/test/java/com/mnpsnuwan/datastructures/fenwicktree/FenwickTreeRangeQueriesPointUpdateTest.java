 ...
 * Class : {@link FenwickTreeRangeQueriesPointUpdateTest}
 * User : Nuwan Samarasinghe | mnpsnuwan@gmail.com
 * Date : 05Dec2023
 * Time : 10:31 AM
 */
public class FenwickTreeRangeQueriesPointUpdateTest
{
    ...
    public void testIntervalSumPositiveValues() {
        ...
        FenwickTreeRangeQueriesPointUpdate ft = new FenwickTreeRangeQueriesPointUpdate(ar);
    ...
    public void testRandomizedStaticSumQueries() {
        ...
        for (int i = 1; i <= LOOPS; i++) {
            ...
            FenwickTreeRangeQueriesPointUpdate ft = new FenwickTreeRangeQueriesPointUpdate(randList);
    ...
    public void doRandomRangeQuery(long[] arr, FenwickTreeRangeQueriesPointUpdate ft) {
    ...
    public void testReUsability() {
        ...
        int SIZE = 1000;
        FenwickTreeRangeQueriesPointUpdate ft = new FenwickTreeRangeQueriesPointUpdate(SIZE);
    ...
    public void testIllegalCreation() {
        assertThrows(IllegalArgumentException.class, () -> new FenwickTreeRangeQueriesPointUpdate(null));
    }
